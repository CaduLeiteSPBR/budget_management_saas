...
## Feature: Data de Fechamento de Cartão de Crédito
- [x] Adicionar campo creditCardClosingDay ao schema de usuário
- [x] Implementar lógica de cálculo de período baseado em data de fechamento
